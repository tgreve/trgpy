...
#
#
def atmospheric_transmission(pwv=1.00):
    """
       Returns atmospheric transmission (frequency vs transmission percentage)
       for given input pwv (default pwv=1.00).

       Uses models from
       http://almascience.eso.org/about-alma/weather/atmosphere-model of the
       transmission for the ALMA site (Alt = 5040m) for pwv=0.25, 0.50, 1.0,
       2.0, 3.0, 5.0. The frequency ranges is 10GHz to 1010GHz.
    """
